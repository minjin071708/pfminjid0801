...
export const article = {
  author: '졸업',
  date: '2017-06-01',
  title: 'IUNIVERSITY OF THE HUMAINTIES 영어영문학 학사 (학점 : 3.4 / 4.0) 졸업',
  description:
    '#linguistics #phonetics an morphology # Syntax #Business English #Translation theory #IELTS #TOEFL #Translation theory',
}
