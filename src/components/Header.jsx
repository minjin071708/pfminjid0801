      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            <MobileNavItem href="/about">자기 소개</MobileNavItem>
            <MobileNavItem href="/articles">학력</MobileNavItem>
            <MobileNavItem href="/projects">포트폴리오</MobileNavItem>
            <MobileNavItem href="/uses">경력</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/about">자기 소개</NavItem>
        <NavItem href="/articles">학력</NavItem>
        <NavItem href="/projects">포트폴리오</NavItem>
        <NavItem href="/uses">경력</NavItem>
      </ul>
    </nav>
  )
}
